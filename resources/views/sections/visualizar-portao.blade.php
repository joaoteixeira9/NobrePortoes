                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-effect">
                                ...
                                <div>
                                    <strong class="d-block text-muted small">Cor</strong>
                                    <span class="fs-6">{{ $portao->cor }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-effect">
                                <i class="bi bi-arrows-expand text-primary me-3 fs-5"></i>
                                <div>
                                    <strong class="d-block text-muted small">Largura</strong>
                                    <span class="fs-6">{{ $portao->largura }}m</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-effect">
                                <i class="bi bi-arrows-expand-vertical text-primary me-3 fs-5"></i>
                                <div>
                                    <strong class="d-block text-muted small">Altura</strong>
                                    <span class="fs-6">{{ $portao->altura }}m</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-effect">
                                <i class="bi bi-calculator text-primary me-3 fs-5"></i>
                                <div>
                                    <strong class="d-block text-muted small">Área Total</strong>
                                    <span class="fs-6">{{ $portao->largura * $portao->altura }}m²</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
// Script simples apenas para atualizar o modal
